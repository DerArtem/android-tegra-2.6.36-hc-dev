...
#if 0 /* Not populated on Betelgeuse board */
	[4] = {
...
struct gpio_shortlong_key_platform_data betelgeuse_longshortkey_pdata = {
...
struct platform_device betelgeuse_longshortkey_device = {
	.name	= "gpio-shortlong-kbd",
	.dev	= {
		.platform_data = &betelgeuse_longshortkey_pdata,
	},
};

static struct platform_device *betelgeuse_pmu_devices[] __initdata = {
	&betelgeuse_longshortkey_device,
